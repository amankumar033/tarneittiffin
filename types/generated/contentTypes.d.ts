...
export interface ApiAboutUsAboutUs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    party_catering: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    tiffin_service_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiAdditonalEquipmentAdditonalEquipment
  extends Struct.CollectionTypeSchema {
  collectionName: 'additonal_equipments';
  info: {
    displayName: 'additonal_equipment';
    pluralName: 'additonal-equipments';
    singularName: 'additonal-equipment';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    additional_equipment_id: Schema.Attribute.UID;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBgImageBgImage extends Struct.CollectionTypeSchema {
  collectionName: 'bg_images';
  info: {
    displayName: 'bg_image';
    pluralName: 'bg-images';
    singularName: 'bg-image';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    home_bg: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::bg-image.bg-image'
    > &
      Schema.Attribute.Private;
    party_catering_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    tiffin_bg: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCrockeryCrockery extends Struct.CollectionTypeSchema {
  collectionName: 'crockeries';
  info: {
    displayName: 'crockery';
    pluralName: 'crockeries';
    singularName: 'crockery';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFoodItemFoodItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    price: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    Qauntity: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiLogoLogo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    web_logo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
  };
}
...
export interface ApiTiffinOrderTiffinOrder extends Struct.CollectionTypeSchema {
  collectionName: 'tiffin_orders';
  info: {
    displayName: 'tiffin_order';
    pluralName: 'tiffin-orders';
    singularName: 'tiffin-order';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    additional_note: Schema.Attribute.String;
    address: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTiffinTiffin extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::additonal-equipment.additonal-equipment': ApiAdditonalEquipmentAdditonalEquipment;
      'api::bg-image.bg-image': ApiBgImageBgImage;
      'api::category.category': ApiCategoryCategory;
      'api::crockery.crockery': ApiCrockeryCrockery;
